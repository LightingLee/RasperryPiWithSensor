...
class BM280:
	...
	def readData(self):
		...
		self.temp = self.compensate_T(temp_raw)
		self.pres = self.compensate_P(pres_raw)
		self.hum = self.compensate_H(hum_raw)

		print 'temp is : ', self.temp
		print 'pres is : ', self.pres
		print 'hum is : ', self.hum
